...
public class ModelGenerator {
    ...
    public Classifier buildClassifierDT(Instances traindataset) {
...
//    We should be able to hotswap stuff out, once we have the dataset...
//    J: YES: we should be able to swap this to a decision tree!!
